	...
	<?php
		...
		<div class="ms-section">
			<div class="ms-content">
				...
				<a class="button-style-2 btn-common rt-animation-out" href="<?php echo esc_url( $split_item_list['button_url']['url'] );?>"><?php echo esc_html( $split_item_list['button_text'] );?><?php echo radius_arrow_shape(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- returns trusted static SVG markup. ?></a>
			</div>
			...
			<div class="small-image-left">
				<?php if ( !empty( $split_item_list['image_small']['id'] ) ) { 
					...
					echo '<img class="wp-post-image" src="' . esc_url( TechkitTheme_Helper::get_img( 'noimage.jpg' ) ) . '" alt="' . esc_attr( get_the_title() ) . '">';
				} ?>
			</div>
			<?php } ?>
		</div>
